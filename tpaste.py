...
# Parser options...
parser.add_option("-t", "--title", action="store_true", dest="p_name", default="Title of paste", help="Your Paste-name e.g, 'Hello Totul!'")
parser.add_option("-c", "--code", action="store_true", dest="p_code", default="Hello World!", help="Your source-code file name with extension...")
...
parser.add_option("-e", "--expiry", action="store_true", dest="p_expire_date", default="10M", help="Valid options are N, 10M, 1H, 1D, 1M ('None', '10 Minutes', '1 Hour', '1 Day', '1 Month'")
...
# if a user insert paste name then he/she will get a url
if options.p_name == True:
